...
const S = {
  finder: '<path d="M37 43v5M63 43v5"/><path d="M36 60q14 11 28 0" stroke="#54a8ff"/>',
  ...
  mail: '<rect x="28" y="35" width="44" height="30" rx="6"/><path d="M30 39 50 53 70 39" stroke="#54a8ff"/>',
  messages: '<path d="M30 35h40a8 8 0 0 1 8 8v11a8 8 0 0 1-8 8H49l-12 9v-9h-3a8 8 0 0 1-8-8V43a8 8 0 0 1 8-8Z" fill="#fff" stroke="none"/><g fill="#34c759" stroke="none"><circle cx="42" cy="48" r="2.4"/><circle cx="50" cy="48" r="2.4"/><circle cx="58" cy="48" r="2.4"/></g>',
  ...
  preview: '<rect x="30" y="33" width="40" height="34" rx="5"/><circle cx="42" cy="45" r="4" fill="#54a8ff" stroke="#54a8ff"/><path d="M32 63 46 52 56 60 68 49"/>',
  textedit: '<path d="M38 30h16l12 12v26a3 3 0 0 1-3 3H38a3 3 0 0 1-3-3V33a3 3 0 0 1 3-3z"/><path d="M54 30v12h12"/><path d="M42 50h16M42 58h12" stroke="#54a8ff"/>',
  ...
  dictionary: '<rect x="34" y="30" width="32" height="40" rx="4"/><rect x="56" y="29" width="6" height="13" rx="1" fill="#ff6f6f" stroke="none"/><path d="M44 60l6-18 6 18M46 53h8"/>',
  ...
  books: '<path d="M50 38v30" stroke="#ff9f0a"/><path d="M31 41q9-4 19-2v30q-10-2-19 2zM69 41q-9-4-19-2"/>',
  appstore: '<path d="M37 64 50 35 63 64M43.5 55h13" stroke="#54a8ff"/>',
  settings: '<circle cx="50" cy="50" r="9"/><circle cx="50" cy="50" r="3.4" fill="#54a8ff" stroke="none"/><g stroke-width="7"><path d="M50 28v8M50 64v8M28 50h8M64 50h8M34 34l6 6M60 60l6 6M66 34l-6 6M40 60l-6 6"/></g>',
  terminal: '<path d="M34 41 45 50 34 59"/><path d="M50 60h16" stroke="#34c759"/>',
  activity: '<path d="M30 50h9l5-13 8 26 6-15 4 2h8" stroke="#34c759"/>',
  diskutil: '<circle cx="50" cy="50" r="20"/><circle cx="50" cy="50" r="5" fill="#54a8ff" stroke="#54a8ff"/><path d="M50 30v8"/>',
  console: '<rect x="30" y="34" width="40" height="32" rx="4"/><path d="M30 44h40"/><path d="M37 53l5 4-5 4M48 61h10" stroke="#34c759"/>',
  keychain: '<circle cx="42" cy="44" r="9" stroke="#f5c000"/><path d="M48 50 64 66M58 60l5-5M54 64l5-5"/>',
  screenshot: '<path d="M34 42v-6a2 2 0 0 1 2-2h6M58 34h6a2 2 0 0 1 2 2v6M66 58v6a2 2 0 0 1-2 2h-6M42 66h-6a2 2 0 0 1-2-2v-6"/><circle cx="50" cy="50" r="6" fill="#54a8ff" stroke="#54a8ff"/>',
  automator: '<rect x="36" y="40" width="28" height="22" rx="5"/><circle cx="44" cy="51" r="2.6" fill="#bf5af2" stroke="none"/><circle cx="56" cy="51" r="2.6" fill="#bf5af2" stroke="none"/><path d="M50 40v-6"/><circle cx="50" cy="32" r="2.4" fill="#fff" stroke="none"/>',
  quicktime: '<circle cx="50" cy="50" r="20"/><path d="M45 41l15 9-15 9z" fill="#54a8ff" stroke="#54a8ff"/>',
  fontbook: '<path d="M37 65 48 35 59 65"/><path d="M42 55h13" stroke="#ff6f6f"/>',
  imagecapture: '<rect x="31" y="40" width="38" height="24" rx="5"/><circle cx="50" cy="52" r="7" fill="#37d6c8" stroke="#37d6c8"/><path d="M50 26v9M46 31l4 4 4-4"/>',
  ...
  missioncontrol: '<rect x="32" y="34" width="15" height="13" rx="2"/><rect x="53" y="34" width="15" height="13" rx="2" stroke="#54a8ff"/><rect x="32" y="53" width="15" height="13" rx="2"/><rect x="53" y="53" width="15" height="13" rx="2"/>',
  siri: '<circle cx="50" cy="50" r="17"/><circle cx="50" cy="50" r="9" stroke="#bf5af2"/>',
  timemachine: '<circle cx="50" cy="50" r="16"/><path d="M50 50V40M50 50l8 4"/><path d="M50 28a22 22 0 1 1-19 11" stroke-width="5" stroke="#34c759"/><path d="M31 33v6h6" stroke="#34c759"/>',
  sysinfo: '<circle cx="50" cy="50" r="18"/><path d="M50 47v15" stroke="#54a8ff"/><circle cx="50" cy="40" r="2" fill="#54a8ff" stroke="none"/>',
};
