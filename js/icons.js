...
const S = {
  ...
  music: '<path d="M44 63V35l20-5v28"/><ellipse cx="39" cy="63" rx="6" ry="5" fill="#fff" stroke="none"/><ellipse cx="59" cy="58" rx="6" ry="5" fill="#fff" stroke="none"/>',
  podcasts: '<circle cx="50" cy="60" r="4.5" fill="#fff" stroke="none"/><path d="M40 52a14 14 0 0 1 20 0"/><path d="M34 45a23 23 0 0 1 32 0"/>',
  news: '<rect x="30" y="33" width="40" height="34" rx="4"/><path d="M37 42h12M37 50h26M37 58h26"/>',
  stocks: '<path d="M32 60 44 48 52 54 67 37"/><path d="M60 37h7v7"/>',
  home: '<path d="M31 50 50 32 69 50"/><path d="M37 47v20h26V47"/>',
  ...
  terminal: '<path d="M34 41 45 50 34 59"/><path d="M50 60h16"/>',
